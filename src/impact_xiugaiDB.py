...
RsgGroupBox(name='GroupBox_14', p='HFrame_19', text='Model type', layout='0')
RsgRadioButton(p='GroupBox_14', text='1/4 model', keyword='GroupBox14', default=False)
RsgRadioButton(p='GroupBox_14', text='1/2 model', keyword='GroupBox14', default=False)
RsgGroupBox(name='GroupBox_15', p='HFrame_19', text='Material', layout='0')
RsgComboBox(name='ComboBox_1', p='GroupBox_15', text='Metal:', keyword='Metal_name', default='', comboType='STANDARD', repository='', rootText='', rootKeyword='None', layout='')
RsgComboBox(name='ComboBox_2', p='GroupBox_15', text='FRP:   ', keyword='polymer_name', default='', comboType='STANDARD', repository='', rootText='', rootKeyword='None', layout='')
